...
class Qwen3Attention(nn.Module):
    def __init__(
        ...
        tp_size = dist.get_world_size()   # returns number of gpus available

        # split heasd based on gpus
        ...
        self.softmax_scaling = self.head_dim ** -0.5
        ...
        self.attn = Attention(self.num_heads, self.head_dim, self.softmax_scaling, self.num_kv_heads)
